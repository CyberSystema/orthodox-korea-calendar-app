...
> often. Treat exact numbers as "verify on the day"; the *process* is stable.
...
- **Individual vs Organization:**
  - *Individual* — fastest; your personal/legal name appears as the seller.
  - *Organization* — requires a **D‑U‑N‑S number** (free, can take days to issue),
...
- For paid apps / in‑app purchases you must sign **Paid Apps agreements** and
  enter banking + tax info in *Agreements, Tax, and Banking*. Free apps only need
...
- **App name** (App Store ≤30 chars; Play ≤30 chars) — must be unique enough to be
  ...
  *store listing* name is set separately in each console and can differ.
...
- On the version page, **Add for Review → Submit**. Answer export compliance,
  content rights, IDFA/advertising questions. Status flows: *Waiting for Review →
  In Review → Pending Developer Release / Ready for Sale* (or *Rejected*).
...
- **Apple release options:** *Manually release* (you click after approval),
  *Automatically*, or *Scheduled*. For a first launch, **manual** gives control.
...
- [ ] Icons + screenshots (iPhone 6.7"/6.9", iPad if tablet stays on, Android phone
      + 1024×500 feature graphic) prepared in both languages (en + ko).
