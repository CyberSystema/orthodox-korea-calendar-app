  ...
  return (
    <Svg width={size} height={size} viewBox="0 0 220 220">
      ...
      <G>
        ...
        <G opacity={simplified ? 0.75 : 0.92} stroke="url(#ringGold)" strokeWidth="2.2" fill="none" strokeLinecap="round" strokeLinejoin="round">
        ...
        <G opacity={simplified ? 0.82 : 1}>
          ...
          <Line x1="84" y1="66" x2="84" y2="46" stroke={colors.accentBright} strokeWidth="4" strokeLinecap="round" />
          <Line x1="136" y1="66" x2="136" y2="46" stroke={colors.accentBright} strokeWidth="4" strokeLinecap="round" />
          <Rect x="80" y="102" width="60" height="42" rx="12" fill={colors.surface} />

          <G stroke="url(#mark)" strokeWidth="4.4" strokeLinecap="round" strokeLinejoin="round" fill="none">
            <Path d="M110 108 L110 136" />
            <Path d="M96 122 L124 122" />
            <Path d="M93 150 L104 162 L128 138" stroke={colors.accent} />
          </G>

          <G opacity={simplified ? 0.7 : 0.92} stroke={ringStroke} strokeWidth="2.2" fill="none" strokeLinecap="round">
